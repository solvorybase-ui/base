...
- und bei einer Ablehnung, warum vorhandene Vorteile nur Qualitäts-, Marketing-, Design- oder etablierte Standardmerkmale sind, falls dies der entscheidende Grund ist.

Keine Aussagen zu HIT / NO HIT / SPÄTER.

---

## Änderung gegenüber Product Scout V2

V3 ergänzt ausschließlich die fachliche Abgrenzung für bekannte und weit verbreitete Standard-Zusatzfunktionen.

Neu ist:

- Eine etablierte und gewöhnliche Zusatzfunktion reicht allein nicht mehr für `selected`.
- Beispiel: Zugstopp bei einem Hundehalsband reicht allein nicht aus.
- Solche Funktionen können nur zusammen mit einer weiteren relevanten funktionalen Besonderheit zu `selected` führen.
- Daraus folgt ausdrücklich keine allgemeine Pflicht zu außergewöhnlichen oder spektakulären Funktionen.
- Bei unbekannten, neuartigen oder schwer einzuordnenden Funktionen bleibt der Scout weiterhin großzügig und wählt bei echter Unsicherheit eher `selected`.

Alle übrigen Regeln aus V2 bleiben unverändert.
