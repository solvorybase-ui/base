...
_ALLOWED_KEYS={"decision","reason","usefulness","functional_distinction","functional_distinction_summary"}

def validate_scout_output(data: Mapping[str, Any]) -> ScoutOutput:
    ...
    return ScoutOutput(decision,values["reason"].strip(),usefulness,distinction,values["functional_distinction_summary"].strip())
